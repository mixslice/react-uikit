  ...
  render() {
    ...
    const styles = {
      ...
      raisedButton: {
        ...
        boxShadow:
          `0 ${_p.shadows[0][0]}px ${_p.shadows[0][1]}px
           ${color(_p.shadowColor).alpha(_p.shadows[0][2]).rgbString()},
           0 ${_p.shadows[0][3]}px ${_p.shadows[0][4]}px
           ${color(_p.shadowColor).alpha(_p.shadows[0][5]).rgbString()}`
      },
      primary: {
        backgroundColor: colors.primaryColor,
